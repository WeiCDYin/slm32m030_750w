...
#ifndef _SLM32X030_HAL_SPI_H_
#define _SLM32X030_HAL_SPI_H_
...
/**
  * @brief  HAL SPI callback Type structure definition
  */
typedef enum
{
    HAL_SPI_CALLBACK_NONE = 0x00U,    /*!< no callback                         */
    HAL_SPI_CALLBACK_IT   = 0x01U,    /*!< callback from SPI interrupt         */
    HAL_SPI_CALLBACK_DMA  = 0x02U,    /*!< callback from DMA interrupt         */
}HAL_SPI_CallbackTypeDef;
...
typedef struct __SPI_HandleTypeDef
{
    ...
    __IO HAL_SPI_CallbackTypeDef    Callback;  /*!< SPI communication state */
...
#define HAL_SPI_ERROR_FLAG              (0x00000020UL)   /*!< Flag: RXNE,TXE, BSY  */
/**
  * @}
  */
...
#define SPI_MODE_MASTER                 (SPI_CR1_MST | SPI_CR1_SSI)
/**
  * @}
  */
...
/** @brief  Reset the CRC calculation of the SPI.
  ...
  * @retval None
  */
#define SPI_RESET_CRC(__HANDLE__)                       do{                                                            \
...
#define IS_SPI_DIRECTION(MODE)                          (((MODE) == SPI_DIRECTION_2LINES) || ((MODE) == SPI_DIRECTION_2LINES_RXONLY) || \
...
#define IS_SPI_NSS(NSS)                                 (((NSS) == SPI_NSS_SOFT) || ((NSS) == SPI_NSS_HARD_INPUT) || \
                                                         ((NSS) == SPI_NSS_HARD_OUTPUT))

#define IS_SPI_BAUDRATE_PRESCALER(PRESCALER)            (((PRESCALER) == SPI_BAUDRATEPRESCALER_2) || ((PRESCALER) == SPI_BAUDRATEPRESCALER_4) || \
