...
#ifndef _SLM32X030_HAL_AWK_H_
#define _SLM32X030_HAL_AWK_H_
...
typedef struct
{   
    uint32_t ClkSel;      /*!< Specifies low power timer clock. This parameter can be a value of @ref AWK_ClkSel */
    uint32_t ClkDiv;      /*!< Specifies tog function enable or disable. This parameter can be a value of @ref AWK_ClkDiv */ 
...
/** @defgroup AWK_ClkSel AWK function clock source select
  * @{
  */
#define AWK_CR_TCLKSEL_0                                (0x1UL << AWK_CR_TCLKSEL_Pos)
#define AWK_CR_TCLKSEL_1                                (0x2UL << AWK_CR_TCLKSEL_Pos)

#define AWK_CLOCK_PCLK                                  (0x00000000U)                                                                   /*!< Clock source PCLK */
#define AWK_CLOCK_DIV_HSE                               (AWK_CR_TCLKSEL_0)                                                              /*!< Clock source HSE after frequency division */
#define AWK_CLOCK_LSI                                   (AWK_CR_TCLKSEL_1)                                                              /*!< Clock source LSI */
#define AWK_CLOCK_LSE                                   (AWK_CR_TCLKSEL_1 | AWK_CR_TCLKSEL_0)                                           /*!< Clock source LSE */
/**
  * @}
  */
...
/** @defgroup AWK_ClkDiv AWK function clock divider
  * @{
  */
#define AWK_CR_DIVSEL_0                                 (0x1UL << AWK_CR_DIVSEL_Pos)
#define AWK_CR_DIVSEL_1                                 (0x2UL << AWK_CR_DIVSEL_Pos)
#define AWK_CR_DIVSEL_2                                 (0x4UL << AWK_CR_DIVSEL_Pos)
#define AWK_CR_DIVSEL_3                                 (0x8UL << AWK_CR_DIVSEL_Pos)
