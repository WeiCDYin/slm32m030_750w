...
#ifndef _SLM32X030_HAL_LPTIM_H_
#define _SLM32X030_HAL_LPTIM_H_
...
typedef struct
{
    uint32_t GateEnable;          /*!< Specifies gate function enable or disable. This parameter can be a value of @ref LPTIM_GateEnable */        

    uint32_t GateLevel;           /*!< Specifies gate level high or low. This parameter can be a value of @ref LPTIM_GateLevel */ 

    uint32_t ClkSel;              /*!< Specifies low power timer clock. This parameter can be a value of @ref LPTIM_ClkSel */        

    uint32_t TogEnable;           /*!< Specifies tog function enable or disable. This parameter can be a value of @ref LPTIM_TogEnable */ 

    uint32_t CntTimSel;           /*!< Specifies Counter/Timer function selection. This parameter can be a value of @ref LPTIM_CntTimSel */     

    uint32_t AutoReload;          /*!< Specifies Timer auto reload enable or disable. This parameter can be a value of @ref LPTIM_AutoReload */        
...
#define LPTIM_CLOCK_SOURCE_LXT              (0x3UL << LPTIM_CR_TCK_SEL_Pos)     /*!< Specify LXT as lptim clock source */
#define LPTIM_CLOCK_SOURCE_LIRC             (0x2UL << LPTIM_CR_TCK_SEL_Pos)     /*!< Specify LIRC as lptim clock source */
/**
  * @}
  */
