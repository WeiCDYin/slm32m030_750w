...
#ifndef _SLM32X030_HAL_LPUART_H_
#define _SLM32X030_HAL_LPUART_H_
...
typedef struct
{
    uint32_t ClkSel;                /*!< Specifies SCLK for LPUART. This parameter can be a value of @ref LPUART_ClkSel */   
    
    uint32_t ClkDiv;                /*!< Specifies SCLK divider for LPUART. This parameter can be a value of @ref LPUART_ClkDiv */   

    uint32_t LowPowerMode;          /*!< Specifies low power mode for LPUART. LPUART can run in normal mode or low power mode by configuration.
    ...
    uint32_t BaudDouble;            /*!< Specifies whether baudrate is doubled. This parameter can be a value of @ref LPUART_BaudDouble */   
    
    uint32_t HalfDuplexMode;        /*!< Specifies whether halfduplex mode is enabled. This parameter can be a value of @ref LPUART_HalfDuplex */   
    
    uint32_t WordLength;            /*!< Specifies the number of data bits transmitted or received in a frame. This parameter can be a value of @ref LPUART_Word_Length */  
    ...
    uint32_t Mode;                  /*!< Specifies whether the Receive or Transmit mode is enabled or disabled. This parameter can be a value of @ref LPUART_Mode */
}LPUART_InitTypeDef;
...
/** @defgroup LPUART_ClkSel LPUART Clock selection
  * @{
  */
#define LPUART_SCON_SCLKSEL_2                               (0x02UL << LPUART_SCON_SCLKSEL_Pos)
#define LPUART_SCON_SCLKSEL_3                               (0x03UL << LPUART_SCON_SCLKSEL_Pos)
#define LPUART_CLOCK_PCLK                                   (0x00000000U)

#define LPUART_CLOCK_LXT                                    LPUART_SCON_SCLKSEL_2
#define LPUART_CLOCK_LIRC                                   LPUART_SCON_SCLKSEL_3
...
#define LPUART_CLOCK_DIV64                                  (0x1 << LPUART_SCON_PRSC_Pos)
#define LPUART_CLOCK_DIV32                                  (0x2 << LPUART_SCON_PRSC_Pos)
#define LPUART_CLOCK_DIV16                                  (0x3 << LPUART_SCON_PRSC_Pos)
#define LPUART_CLOCK_DIV8                                   (0x4 << LPUART_SCON_PRSC_Pos)
#define LPUART_CLOCK_DIV4                                   (0x5 << LPUART_SCON_PRSC_Pos)
#define LPUART_CLOCK_DIV2                                   (0x6 << LPUART_SCON_PRSC_Pos)
#define LPUART_CLOCK_DIV1                                   (0x7 << LPUART_SCON_PRSC_Pos)
...
/** @defgroup LPUART_Word_Length LPUART Word Length
  * @{
  */
#define LPUART_SCON_SM0_SM1_1                               (0x01UL << LPUART_SCON_SM0_SM1_Pos)
#define LPUART_SCON_SM0_SM1_0                               (0x02UL << LPUART_SCON_SM0_SM1_Pos)

#define LPUART_WORDLENGTH_8B_MODE0                          (0x00UL)
#define LPUART_WORDLENGTH_8B_MODE1                          ((uint32_t)LPUART_SCON_SM0_SM1_1)
#define LPUART_WORDLENGTH_9B_MODE2                          ((uint32_t)LPUART_SCON_SM0_SM1_0 )
#define LPUART_WORDLENGTH_9B_MODE3                          ((uint32_t)(LPUART_SCON_SM0_SM1_0 | LPUART_SCON_SM0_SM1_1))
/**
  * @}
  */
...
/**
  * @}
  */ /* End of group SLM32X030_HAL_Driver */

#ifdef __cplusplus
    }
#endif

#endif /* _SLM32X030_HAL_LPUART_H_ */
