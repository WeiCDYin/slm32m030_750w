...
#ifndef _SLM32X030_HAL_RTC_H_
#define _SLM32X030_HAL_RTC_H_
...
typedef struct
{
    RTC_AlarmEnableTypeDef gst_hrtc_alarmenable;
...
/** 
  * @brief  RTC intrusion detection configuration  
  */
typedef struct
{
    uint32_t TAMP_DB;         /*!< Intrusion detection dejitter setting */  
    uint32_t TAMP_MODE;       /*!< Configure intrusion detection events */
    uint32_t TAMPIE;          /*!< Intrusion detection interrupt enable control */
    uint32_t TAMPE;           /*!< Control of the detection function on the intrusion PIN */
}RTC_IntrudeTypeDef;
...
typedef struct __RTC_HandleTypeDef
{
    ...
    RTC_TimeTypeDef             TimeToUpdate;   /*!< Current time set by user and updated automatically  */ 
    ...
    void (* CycleEventCallback)(struct __RTC_HandleTypeDef *hrtc); 
    void (* TampfEventCallback)(struct __RTC_HandleTypeDef *hrtc);
    void (* TampovfEventCallback)(struct __RTC_HandleTypeDef *hrtc);  
}RTC_HandleTypeDef;
...
/**
  ...
  * @{
  */
#define RTC_TIME_ADJUST_SEC60               (0x00UL << RTC_CLKCALR_MODE_Pos)
#define RTC_TIME_ADJUST_SEC30               (0x01UL << RTC_CLKCALR_MODE_Pos)
#define RTC_TIME_ADJUST_SEC15               (0x02UL << RTC_CLKCALR_MODE_Pos)
#define RTC_TIME_ADJUST_SEC06               (0x03UL << RTC_CLKCALR_MODE_Pos)
/**
  * @}
  */
  ...
  * @{
  */
#define RTC_CLOCK_NULL                      (0x00UL << RCMU_BDCR_RTCSEL_Pos)
#define RTC_CLOCK_LSE                       (0x01UL << RCMU_BDCR_RTCSEL_Pos)
#define RTC_CLOCK_LSI                       (0x02UL << RCMU_BDCR_RTCSEL_Pos)
#define RTC_CLOCK_HSE                       (0x03UL << RCMU_BDCR_RTCSEL_Pos)

/** 
  * @brief  HAL RTC CEN 
  */ 

#define HAL_RTC_YEAR_1900                   (0x0000U)            
#define HAL_RTC_YEAR_2000                   RTC_DATE_CEN                                                                   
...
#define RTC_TAMPF                           (0x02U)    
#define RTC_TAMPOVF                         (0X03U)       

/** @defgroup RTC_Alarm output selection
  * @{
  */ 
#define OSEL_0                              (0x00UL << RTC_CR_OSEL_Pos)   /*!< Output inhibit */
#define OSEL_1                              (0x01UL << RTC_CR_OSEL_Pos)    /*!< Alarm1 output enable */
#define OSEL_2                              (0x02UL << RTC_CR_OSEL_Pos)    /*!< retain */
#define OSEL_3                              (0x03UL << RTC_CR_OSEL_Pos)    /*!< Alarm2 output enable */
...
/** @defgroup Intrusion detection dejitter setting
  * @{
  */ 
#define TAMP_DB_0                           (0x00UL << RTC_TAFCR_TAMP_DB_Pos)       /*!< No jitter removal function */
#define TAMP_DB_1                           (0x01UL << RTC_TAFCR_TAMP_DB_Pos)        /*!< 2ms */
#define TAMP_DB_2                           (0x02UL << RTC_TAFCR_TAMP_DB_Pos)        /*!< 4ms */
#define TAMP_DB_3                           (0x03UL << RTC_TAFCR_TAMP_DB_Pos)        /*!< 6ms */

/** @defgroup Configure intrusion detection events
  * @{
  */ 
#define TAMP_MODE_0                         (0x00UL << RTC_TAFCR_TAMP_MODE_Pos)        /*!< Rising edge */
#define TAMP_MODE_1                         (0x01UL << RTC_TAFCR_TAMP_MODE_Pos)        /*!< Falling edge */
#define TAMP_MODE_2                         (0x02UL << RTC_TAFCR_TAMP_MODE_Pos)        /*!< Rising edge and falling edge */
#define TAMP_MODE_3                         (0x03UL << RTC_TAFCR_TAMP_MODE_Pos)        /*!< Positive pulse with dejitter function */
#define TAMP_MODE_4                         (0x04UL << RTC_TAFCR_TAMP_MODE_Pos)        /*!< Negative pulse with dejitter function */  

/** @defgroup Intrusion detection interrupt enable control
  * @{
  */ 
#define IRQ_Disable                         (0x00UL << RTC_TAFCR_TAMPIE_Pos)    /*!< IRQ_Disable */
#define IRQ_Enable                          (0x01UL << RTC_TAFCR_TAMPIE_Pos)    /*!< IRQ_Ensable */

/** @defgroup Control of the detection function on the intrusion PIN
  * @{
  */ 
#define TMAPE_Disable                        (0x00UL << RTC_TAFCR_TMAPE_Pos)    /*!< close TAMPE */
#define TMAPE_Enable                         (0x01UL << RTC_TAFCR_TMAPE_Pos)    /*!< open TAMPE */
...
/**
  ...
  * @retval None.
  */                                                                                 
#define __HAL_RTC_ENTER_RW(__HANDLE__)                              do{                                                     \
...
/**
  ...
  * @retval None.
  */
#define __HAL_RTC_EXIT_RW(__HANDLE__)                               do{                                                       \
                                                                        RTC_Disable_Write_Protected(__HANDLE__);              \
...
#define __HAL_RTC_ENABLE(__HANDLE__)                                do{                                                    \
                                                                        RTC_Disable_Write_Protected(__HANDLE__);           \
...
#define __HAL_RTC_DISABLE(__HANDLE__)                               do{                                                      \
                                                                        RTC_Disable_Write_Protected(__HANDLE__);             \
...
/**
  ...
  * @retval None.
  */
#define __HAL_RTC_ENABLE_CLOCK(__HANDLE__)                          do{                                                            \
                                                                        RTC_Disable_Write_Protected(__HANDLE__);                   \
...
/**
  ...
  * @retval None.
  */
#define __HAL_RTC_DISABLE_CLOCK(__HANDLE__)                         do{                                                              \
                                                                        RTC_Disable_Write_Protected(__HANDLE__);                     \
...
/**
  ...
  * @retval None.
  */
#define __HAL_RTC_ENABLE_Alarm1()                                   SET_BIT(RTC->CR, RTC_CR_ALM1EN)

/**
  * @brief Disable RTC Alarm1.
  * @retval None.
  */
#define __HAL_RTC_DISABLE_Alarm1()                                  CLEAR_BIT(RTC->CR, RTC_CR_ALM1EN)

/**
  * @brief Enable RTC Alm2.
  * @retval None.
  */
#define __HAL_RTC_ENABLE_ALM2()                                     SET_BIT(RTC->CR, RTC_CR_ALM2EN)

/**
  * @brief Disable RTC Alm2.
  * @retval None.
  */
#define __HAL_RTC_DISABLE_ALM2()                                    CLEAR_BIT(RTC->CR, RTC_CR_ALM2EN)

/**
  * @brief Enable RTC Alm2_INTEN.
  * @retval None.
  */
#define __HAL_RTC_ENABLE_Alm2_INTEN()                               SET_BIT(RTC->CR, RTC_CR_ALM2_INTEN)

/**
  * @brief Disable RTC Alm2_INTEN.
  * @retval None.
  */
#define __HAL_RTC_DISABLE_Alm2_INTEN()                              CLEAR_BIT(RTC->CR, RTC_CR_ALM2_INTEN)

/**
  * @brief Enable RTC TAMPIE.
  * @retval None.
  */
#define __HAL_RTC_ENABLE_TAMPIE()                                   do{                                        \
                                                                        CLEAR_REG(RTC->TAFCR);                 \
                                                                        SET_BIT(RTC->TAFCR, RTC_TAFCR_TAMPIE); \
                                                                    } while(0)

/**
  * @brief Disable RTC TAMPIE.
  * @retval None.
  */
#define __HAL_RTC_DISABLE_TAMPIE()                                  CLEAR_BIT(RTC->TAFCR, RTC_TAFCR_TAMPIE)

/**
  * @brief Enable write protection.
  * @retval None.
  */
#define __HAL_RTC_ENABLE_WRITE_PROTECT()                            WRITE_REG(RTC->WPR, 0xFFU)
    
/**
  * @brief Disable write protection.
  * @retval None.
  */
#define __HAL_RTC_DISABLE_WRITE_PROTECT()                           do{                                    \
...
#define IS_RTC_YEAR(YEAR)                   ((YEAR) >= 2000U) &&(YEAR) <= 2199U)
#define IS_RTC_MONTH(MONTH)                 (((MONTH) >= 1U) && ((MONTH) <= 12U))
#define IS_RTC_DATE(DATE)                   (((DATE) >= 1U) && ((DATE) <= 31U))
#define IS_RTC_WEEKDAY(WEEKDAY)             (((WEEKDAY) >= RTC_WEEKDAY_SUNDAY) && ((WEEKDAY) <= RTC_WEEKDAY_SATURDAY))
#define IS_RTC_INT_TYPE(X)                  (((X) == RTC_ALARM_1) || ((X) == RTC_ALARM_2) || ((X) == RTC_TAMPF) || ((X) == RTC_TAMPOVF))
#define IS_RTC_CALIB_OUTPUT(__OUTPUT__)     (((__OUTPUT__) == RTC_OUTPUTSOURCE_NONE) || ((__OUTPUT__) == RTC_OUTPUTSOURCE_CALIBCLOCK) || \
                                             ((__OUTPUT__) == RTC_OUTPUTSOURCE_ALARM) || ((__OUTPUT__) == RTC_OUTPUTSOURCE_SECOND))

#define IS_RTC_ALL_INSTANCE(INSTANCE)       (INSTANCE == RTC)

#define IS_RTC_CLOCK_SOURCE(SOURCE)         ((SOURCE == RTC_CLOCK_LXT) || (SOURCE == RTC_CLOCK_NULL) || \
...
extern HAL_StatusTypeDef HAL_RTC_SetTime(RTC_HandleTypeDef *hrtc, RTC_TimeTypeDef *sTime, uint32_t Format);
...
FlagStatus HAL_RTC_Get_Flag(uint32_t Alarm);
void HAL_RTC_Clear_Flag(uint32_t Alarm);
...
extern void HAL_RTC_Adjust_Config(RTC_HandleTypeDef *hrtc);
extern void HAL_RTC_Ban_Config(void);
extern void HAL_RTC_Intrude_Config(RTC_IntrudeTypeDef *hrtcintrude);

#ifdef __cplusplus
    }
#endif

#endif /* _SLM32X030_HAL_RTC_H_ */
